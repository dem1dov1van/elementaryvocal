...
import type { YMapFeature, YMapMarker, YMapHotspot } from '@yandex/ymaps3-types/imperative';
...
declare const YMapHintContext: import("@yandex/ymaps3-types/imperative/Entities").Context<unknown>;
/**
 * Display hint on map elements.
 *
 * @example
 * ```javascript
 * const {YMapHint, YMapHintContext} = await ymaps3.import('@ymaps3/ymaps3-hint@0.0.1');
...
declare class YMapHint extends ymaps3.YMapGroupEntity<YMapHintProps> {
    static [ymaps3.overrideKeyReactify]: CustomReactify<YMapHint, TReact.FC<TReact.PropsWithChildren<YMapHintProps>>>;
    private _detachDom;
    private _element;
