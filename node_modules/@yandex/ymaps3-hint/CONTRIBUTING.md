...
> To get started in the `.env` file, you need to declare `APIKEY` https://developer.tech.yandex.ru/services
...
- `APIKEY` - To run autotests on the JS API https://yandex.ru/dev/jsapi30/doc/ru/quickstart#get-api-key
