...
> To get started in the `.env` file, you need to declare `APIKEY` and `REFERRER` https://yandex.ru/dev/maps/jsapi/doc/3.0/quickstart.html#get-api-key:
...
- `REFERRER` - To run autotests on the JS API https://yandex.ru/dev/jsapi30/doc/ru/limit
